...
router.put('/:id/follow',async(req,res)=>{
    if(req.body.userId !== req.params.id){
        try {
            ...
            const currentUsers=await User.findById(req.body.userId)
            if(!user.followers.includes(req.body.userId)){
                await user.updateOne({$push:{followers: req.body.userId}})
                await currentUsers.updateOne({$push:{followings: req.params.id}})
    ...
    if(req.body.userId !== req.params.id){
        try {
            ...
            if(user.followers.includes(req.body.userId)){
                ...
                await currentUsers.updateOne({$pull:{followings: req.params.id}})
